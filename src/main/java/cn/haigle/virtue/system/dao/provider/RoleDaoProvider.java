 ...
 */
public class RoleDaoProvider extends DaoProvider {
    ...
    public String list(Page<RoleVo> page, String name) {
        SQL sql = new SQL();
    ...
    public String getTotal(Page<RoleVo> page, String name) {
        SQL sql = new SQL();
        sql.SELECT("count(*)")
                .FROM(TABLE_REPORT);
    ...
    public String save(RoleAo m, Long uid) {
        SQL sql = new SQL();
    ...
    public String update(RoleAo m, Long uid) {
        SQL sql = new SQL();
