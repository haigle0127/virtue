...
public interface LoginDao {
    ...
    UserLoginBo getUserByEmail(String account);
    ...
    UserLoginBo getUserByPhone(String account);
    ...
    UserLoginBo getUserByUsername(String username);
    ...
    UserInfoBo getAdminUserInfo(Long uid);
    ...
    List<String> findPermissionsById(Long uid);
    ...
    @Select("SELECT `name` FROM sys_role sr " +
            ...
            "WHERE sur.user_id = #{uid}")
    List<String> findRolesById(Long uid);
    ...
    void save(RegisterBo adminRegisterPo);
