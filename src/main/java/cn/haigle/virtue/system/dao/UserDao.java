...
import cn.haigle.virtue.system.dao.provider.UserDaoSqlProvider;
...
public interface UserDao {
    ...
    @SelectProvider(type = UserDaoSqlProvider.class, method = "list")
    List<UserVo> list(Page<UserVo> page, String name);
     ...
     */
    @SelectProvider(type = UserDaoSqlProvider.class, method = "getTotal")
    int getTotal(Page<UserVo> page, String name);
     ...
     * @date 2019/9/5 17:06
     */
    @InsertProvider(type = UserDaoSqlProvider.class, method = "save")
    void save(UserDto m, Long uid);
     ...
     * @date 2019/9/6 9:19
     */
    @SelectProvider(type = UserDaoSqlProvider.class, method = "saveUserRole")
     ...
     * @date 2019/9/6 8:50
     */
    @UpdateProvider(type = UserDaoSqlProvider.class, method = "update")
    void update(UserAo m, Long uid);
    ...
    UserVo getUserWithRoleMenuListById(Long uid);
