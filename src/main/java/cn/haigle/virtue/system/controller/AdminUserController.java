...
public class AdminUserController {
    ...
    public ApiResult<String> save(@Validated(Save.class) @RequestBody AdminUserAo adminUserAo) {
        adminUserService.save(adminUserAo, StpUtil.getLoginIdAsLong());
        return ApiResult.ok();
    }
    ...
    @ApiOperation("更新用户")
    @PostMapping("/update")
    public ApiResult<String> update(@Validated(Update.class) @RequestBody AdminUserAo adminUserAo) {
        adminUserService.update(adminUserAo, StpUtil.getLoginIdAsLong());
        return ApiResult.ok();
    }
