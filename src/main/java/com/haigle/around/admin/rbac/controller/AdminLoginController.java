...
import com.haigle.around.admin.rbac.entity.po.AdminPaiPo;
import com.haigle.around.admin.rbac.entity.ao.AdminLoginAo;
import com.haigle.around.admin.rbac.entity.ao.AdminRegisterAo;
import com.haigle.around.admin.rbac.entity.po.AdminUserLoginPo;
import com.haigle.around.admin.rbac.service.AdminLoginService;
import com.haigle.around.admin.rbac.service.AdminPaiService;
...
public class AdminLoginController extends BaseI18n {
    ...
    public ApiResultI18n logout(@RequestHeader(Constant.TOKEN) String token) {
        ...
        return new ApiResultI18n("logout.success", false);
    }
