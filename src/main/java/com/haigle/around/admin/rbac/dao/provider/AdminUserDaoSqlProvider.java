package com.haigle.around.admin.rbac.dao.provider;

import com.haigle.around.admin.rbac.entity.ao.AdminUserAo;
import com.haigle.around.admin.rbac.entity.dto.AdminUserDto;
import com.haigle.around.admin.rbac.entity.vo.AdminUserVo;
 ...
 */
public class AdminUserDaoSqlProvider extends DaoProvider {
    ...
    private static final String[] TITLE = {"id", "username", "email", "phone", "avatar", "introduction", "birth", "school", "education", "company", "create_time"};
    ...
    public String save(AdminUserDto m, Long uid) {
        SQL sql = new SQL();
